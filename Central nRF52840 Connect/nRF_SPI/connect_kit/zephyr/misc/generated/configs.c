...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_CUSTOM_HANDSHAKE_PIN_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ESPRESSIF_ESP32_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MAX_CONN, 20);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 16384);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HRS_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HRS_CLIENT_RR_INTERVALS_COUNT, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HRS_CLIENT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_HRS_CLIENT_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_CONNECTKIT_NRF52840, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0xd3000);
